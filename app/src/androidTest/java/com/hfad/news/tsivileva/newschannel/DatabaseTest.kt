...
class DatabaseTest {
    ...
    fun selectAllDescriptionsTest() {
        val descriptions = mutableListOf(
                Description(id = 125165, date = Date(1581447890000), pictureSrc = "https://tproger.ru/apple-touch-icon.png", sourceKind = FeedsSource.PROGER, link = "https://tproger.ru/events/gtp-indie-cup-winter-2020/", title = "15 января – 2 апреля, онлайн: конкурс Indie Cup'"),
                Description(id = 491362, date = Date(1583504198000), pictureSrc = "https://habrastorage.org/webt/fb/i8/iy/fbi8iyxcyyzik7-ou5-txjc7s8a.jpeg", sourceKind = FeedsSource.HABR, link = "https://habr.com/ru/post/491362/", title = "Java-дайджест за 6 марта")
        )
    ...
    fun selectDescriptionAndContentTest() {
        val description = Description(id = 125165, date = Date(1581447890000), pictureSrc = "https://tproger.ru/apple-touch-icon.png", sourceKind = FeedsSource.PROGER, link = "https://tproger.ru/events/gtp-indie-cup-winter-2020/", title = "15 января – 2 апреля, онлайн: конкурс Indie Cup")
    ...
    fun selectDescriptionAndFawTest() {
        var description = Description(id = 125165, date = Date(1581447890000), pictureSrc = "https://tproger.ru/apple-touch-icon.png", sourceKind = FeedsSource.PROGER, link = "https://tproger.ru/events/gtp-indie-cup-winter-2020/", title = "15 января – 2 апреля, онлайн: конкурс Indie Cup")
        ...
        description = Description(id = 491362, date = Date(1583504198000), pictureSrc = "https://habrastorage.org/webt/fb/i8/iy/fbi8iyxcyyzik7-ou5-txjc7s8a.jpeg", sourceKind = FeedsSource.HABR, link = "https://habr.com/ru/post/491362/", title = "Java-дайджест за 6 марта")
        api.insertIntoDescription(description)
    ...
    fun selectAllDescriptionAndFavTest() {
        ...
        description = Description(id = 491000, date = Date(1583504198000), pictureSrc = "https://habrastorage.org/webt/fb/i8/iy/fbi8iyxcyyzik7-ou5-txjc7s8a.jpeg", sourceKind = FeedsSource.HABR, link = "https://habr.com/ru/post/491362/", title = "Java-дайджест за 6 марта")
        api.insertIntoDescription(description)
