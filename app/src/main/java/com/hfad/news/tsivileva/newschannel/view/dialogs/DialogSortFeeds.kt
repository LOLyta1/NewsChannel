...
import com.hfad.news.tsivileva.newschannel.DATABASE_DATE_COLUMN
import com.hfad.news.tsivileva.newschannel.DATABASE_TITLE_COLUMN
...
class DialogSortFeeds : DialogFragment() {
    ...
    interface IDialogSortFeedsClickListener {
        fun onDialogSortClick(sortKind: Sort, source: FeedsSource)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.dialog_sort_feed_button.setOnClickListener {
            ...
            listener?.onDialogSortClick(sort, source)
            dismiss()
        }
    }
