...
import com.hfad.news.tsivileva.newschannel.Model.implementation.TProger.Item;
            ...
            public void onNext(TProger prog) {
                 ...
                 if(prog.getChannel().getItem().size()>0){
                    ...
                    for (Item i:prog.getChannel().getItem()
                        ...
                        item.setDate(i.getPubDate());
                        item.setTitle(i.getTitle());
                        item.setLink(i.getLink());
                        item.setPicture("https://pbs.twimg.com/profile_images/857551974442651648/D5cZLXTf.jpg");
                        item.setSummarry(i.getDescription());
